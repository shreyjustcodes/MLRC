...
function resolveLogoSrc(logo: string | StaticImageData): string {
...
const PillNav = ({
  ...
  const tlRefs = useRef<Array<gsap.core.Timeline | undefined>>([]);
  const activeTweenRefs = useRef<Array<gsap.core.Tween | gsap.core.Timeline | undefined>>([]);
